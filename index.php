...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>ADIRMODZ CHECKER V1</title>
...
<div class="text-center">
        <h2 class="text-light"><b>ADIRMODZ CHECKER <br>VERSION V1</b></h2><br>
        <div class="text-center ">
        <center><h class="text-light"><b><p>CODEADO POR ADIRMODZ</p></b></h></center>
		<center><h class="text-light"><b><span class='badge badge-warning'>Use E Abuse !</span></b></h></center>
		<center><h class="text-light"><b><span class='badge badge-dark'>FORMATO : CC|MES|AÑO|CVV</span></b></h></center>

    </div>

   
    <fieldset class="form-group">
        <textarea class="form-control bg-dark text-light" style="resize: none;text-align: center;margin: auto;" rows="12" id="lista" maxlength="8699" placeholder=""></textarea>
    </fieldset>
    ...
    <center>
        <div class="mb-3">
            ...
            <a href="../../" class="btn btn-primary btn-min-width mr-1 mb-1">VOLVER</a>
        </div>
    </center>
    ...
    <center>
        <div class="text-center text-light mt-3">
            <h4 class="text-light" id="status_ccs">GUARDANDO INICIO</h4>
        </div>
    </center>
    ...
    <div class="col-md-12 mt-3 p-0">
        <div class="card bg-dark text-light">
            ...
            <div class="card-body">
                <h6 style="font-weight: bold;" class="card-title text-light">APROBADAS - <span  id="cLive2" class="badge badge-success">0</span></h6>
    ...
    <div class="col-md-12 mt-3 p-0">
        <div class="card bg-dark text-light">
            ...
            <div class="card-body">
                <h6 style="font-weight: bold;" class="card-title text-light">DENEGADAS - <span  id="cDie2" class="badge badge-danger">0</span></h6>
...
var audioLive = new Audio('live.mp3');
	...
	<center><h2 class="text-light"><b><span class='badge badge-danger'>USALO BIEN :)</span></b></h2></center><br></br><br></br><br></br><br></br><br></br><br></br><br></br>
	
	<center><h class="text-light"><b>NOTA: TODOS LOS CHK VBV/MSC<br>COMPROBANDO SI TIENE<br>redireccionamiento<br>DESDE EL SITIO WEB DE ADIRMODZ CHECKER V1<br>TIENES RIEGOS DE<br>FALSO VIVIR EN 50%<br>NO CULPAR PUERTA DE GATE<br>O EL CODIFICADO</b></h></center><br><br>
	
	<center><h class="text-light"><b>Copyright ADIRMODZ SQUAD 2021</b></h></center>

    <center><h class="text-light"><b>SERVER DISCORD https://discord.com/invite/adirsquad !!!</b></h></center>
  </body>
</html>